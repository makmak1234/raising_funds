...
namespace App\Http\Controllers\MyFunction;
...
class Transport{
    private $EMAIL        = "k0001026@gmail.com";
    private $PASSWORD     = "xyz1516abc000cba";
    private $SENDER       = "KSRI";
    ...
    function send($params = array(), $phones = array()){
        ...
        foreach ($phones as $phone){
                $ok = $sms->smsapi_push_msg_nologin($this->EMAIL, $this->PASSWORD, "7".$phone, $params['text'], ["sender_name" => $this->SENDER]);
            }
...
class Sms
{
    ...
    function myfunction(){
        $myecho = "myfunction";
        `echo " myfunction: $myecho    " >>/tmp/qaz`;
        return;
    }
