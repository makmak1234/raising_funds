    ...
    <div class="modal-content">
      ...
      <div class="modal-body" >
        <div class="alert alert-danger" role="alert">
            Удалить инвестицию 
            <label class="alert-link" id="invest_amount">...</label> ?
        </div>
      </div>
                        ...
                        <tbody>
                            @foreach ($invests as $invest)
                                <tr>
                                    ...
                                    <td>
                                        @php
                                            $a_href0 = "href=update_invest/$invest->id/0";
                                            $a_href1 = "href=update_invest/$invest->id/1";
                                            $a_href2 = "href=update_invest/$invest->id/2";
                                            if ($invest->accept == 0){
                                                $inf_cls = "btn-danger";
                                                $a_href0 = "";
                                    ...
                                    <td><a href="update_invest/{{ $invest->id }}" class="btn btn-default" type="button">Редактировать</a></td>
                                    <td><button class="btn btn-danger" type="button" data-toggle="modal" data-target="#myModal" id="{{ $invest->id }}deleteRecord" curid="{{ $invest->id }}" invest_name="{{$invest->amount}}">Удалить</button></td>
                                </tr>
                            @endforeach
                        </tbody>   
                    </table>
