            ...
            <div class="panel panel-default">
                <div class="panel panel-default">
                    ...
                    <div class="list-group-item list-group-item-success">
                        <h3 class="panel-title ">Добавить инвестицию для инвестора {{$investor->name}}</h3>
                    </div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('dash_store_invest') }}">
                        ...
                        <div class="form-group{{ $errors->has('term') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="term" type="date" class="form-control" name="term" value="{{ old('term') }}" min="{{$date_now}}" required autofocus>
